...
class XmlMaterialProfile(InstanceContainer):
    ...
    def xmlVersionToSettingVersion(cls, xml_version: str) -> int:
        if xml_version == "1.3":
            return Application.getInstance().SettingVersion
    ...
    def serialize(self, ignored_metadata_keys: Optional[set] = None):
        ...
        variant_manager = Application.getInstance().getVariantManager()
    ...
    def _loadFile(self, file_name):
        path = Resources.getPath(Application.getInstance().ResourceTypes.MaterialInstanceContainer, file_name + ".xml.fdm_material")
